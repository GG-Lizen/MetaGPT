...
# -*- coding: utf-8 -*-
"""
@Time    : 2024/5/11 17:26
@Author  : GG-Lizen
@File    : cad_search_and_summarize.py
"""
...
class CADSearchAndSummarize(Action):
    name: str = ""
    ...
    async def run(self, context: list[Message], system_text=SEARCH_AND_SUMMARIZE_SYSTEM) -> str:
        ...
        site =" view-part site:https://www.snapeda.com/"
        # logger.debug(query)
        rsp = await self.search_engine.run(query+site)
        self.result = rsp
        if not rsp:
