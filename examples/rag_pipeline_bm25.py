...
class RAGExample:
    ...
    async def init_objects(self):
        ...
        self.engine = SimpleEngine.from_objs(retriever_configs=[BM25RetrieverConfig()])
    ...
    def _print_title(title):
        logger.info(f"\033[92m{'#'*30} {title} {'#'*30}\033[0m")

    @staticmethod
    def _print_retrieve_result(result):
        """\033[0mP rint retrieve result."""
    ...
    def _print_query_result(result):
        """\033[0m Print query result."""
        logger.info("vQuery Result:")
